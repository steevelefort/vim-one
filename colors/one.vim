...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    ...
    let s:hue_2  = ['#41bfff', '255'] " blue
    let s:hue_3  = ['#a698ff', '255'] " purple
    let s:hue_4  = ['#98f379', '255'] " green

    let s:hue_5   = ['#ff5c65', '255'] " red 1
    let s:hue_5_2 = ['#ff4046', '255'] " red 2
    ...
    let s:visual_grey  = ['#3e4452', '255']
    let s:pmenu        = ['#333841', '255']
  else
    let s:mono_1 = ['#494b53', '255']
    let s:mono_2 = ['#696c77', '255']
    let s:mono_3 = ['#a0a1a7', '255']
    let s:mono_4 = ['#c2c2c3', '255']

    let s:hue_1  = ['#0184bc', '255'] " cyan
    let s:hue_2  = ['#4078f2', '255'] " blue
    let s:hue_3  = ['#a626a4', '255'] " purple
    let s:hue_4  = ['#50a14f', '255'] " green

    let s:hue_5   = ['#e45649', '255'] " red 1
    let s:hue_5_2 = ['#ca1243', '255'] " red 2

    let s:hue_6   = ['#986801', '255'] " orange 1
    let s:hue_6_2 = ['#c18401', '255'] " orange 2

    let s:syntax_bg     = ['#fafafa', '255']
    let s:syntax_gutter = ['#9e9e9e', '255']
    let s:syntax_cursor = ['#f0f0f0', '255']

    let s:syntax_accent = ['#526fff', '255']
    let s:syntax_accent_2 = ['#0083be', '255']

    let s:vertsplit    = ['#e7e9e1', '255']
    let s:special_grey = ['#d3d3d3', '255']
    let s:visual_grey  = ['#d0d0d0', '255']
    let s:pmenu        = ['#dfdfdf', '255']
  endif
